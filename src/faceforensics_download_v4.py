...
1. Go to root of environment
2. python faceforensics_download_v4.py faceforensics_dataset -d all -c c40 -t videos --server EU2

Documentation: https://github.com/ondyari/FaceForensics/blob/master/dataset/README.md
